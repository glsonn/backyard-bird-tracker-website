export default function ArticleNewsletterCTA() {
  return (
    <section className="article-newsletter-cta">
      ...
      <p>
        The articles here are meant to be a lasting resource you can return to
        whenever you have a question about the birds in your backyard.
      </p>
      ...
      <a href="/newsletter">Join the Backyard Bird Tracker newsletter →</a>
    </section>
  );
}
